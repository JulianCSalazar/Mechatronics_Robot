...
#define EVENT_CHECK_LIST TWDEventChecker, BeaconEventChecker
...
#define TIMER0_RESP_FUNC PostBumpService
...
#define BUMP_SERVICE_TIMER 0
#define TAPE_SERVICE_TIMER 1
#define TWD_SERVICE_TIMER 2
#define MIN_TIMER 3
#define HSM_TIMER 4
#define HSM_TIMER1 5
#define HSM_TIMER_2 6
#define HSM_TIMER_3 7
#define HSM_TIMER_4 8
#define HSM_TIMER_5 9
#define HSM_TIMER_6 10
#define HSM_TIMER_7 11
#define HSM_TIMER_8 12
#define LINEUP_TIMER 13
#define OH_SHIT_TIMER 14
#define OneSecTimer 15
...
#define SERV_0_HEADER "Bumpers_Service.h"
// the name of the Init function
#define SERV_0_INIT InitBumpService
// the name of the run function
#define SERV_0_RUN RunBumpService
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "Tapes_Service.h"
// the name of the Init function
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "Targets_Service.h"
// the name of the Init function
#define SERV_5_INIT InitTargetService
// the name of the run function
#define SERV_5_RUN RunTargetService
// How big should this services Queue be?
